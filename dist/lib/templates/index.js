...
exports.kycReceivedTemplate = exports.forgotPasswordTemplate = exports.verifyEmailTemplate = void 0;
const verifyEmailTemplate = (url, username) => {
    return `
    <html>
    <head>
...
const kycReceivedTemplate = (username) => {
    return `
    <html>
    <head>
